function setItemInfo(text, itemdata) {
    ...
    itemname = doc.querySelector('#main > div > div.result_item > div > p.itemname').textContent;
    itemexp = doc.querySelector('#main > div > div.result_item > div > p.itemexp').innerHTML;
